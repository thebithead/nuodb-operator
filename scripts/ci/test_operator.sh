...
operator-sdk test local ./test/e2e --namespace $OPERATOR_NAMESPACE --debug --verbose --kubeconfig $HOME/.kube/config --up-local --image $NUODB_OP_IMAGE --go-test-flags "-short"

...
**Note:** The NuoDB Operator is ideal for development, test and evaluation deployments. The NuoDB Operator is not yet available for production use. Coming soon 1H'20, automated LEVEL 2 (rolling upgrade) and LeVEL 3 (backup and recovery) operational cabability!
